...
const optimalLocations = JSON.parse(fs.readFileSync('../data/optimal-locations-optimal-tracks.json', 'utf8'));
...
async function validateTracks() {
    console.log('Comparing matrix vs. actual optimal locations on optimized tracks:\n');
